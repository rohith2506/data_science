...
class DecisionTree():
    def __init__(self):
        ...
        self.tree = GradientBoostingRegressor(max_depth=2)
    ...
    def test(self, acceptable_range):
        print "Testing data....."
        cnt = 0
        pred_test = self.tree.predict(self.test_x)
...
if __name__ == "__main__":
    tr = DecisionTree()
    print "Enter to the world of Decision Tree!!!!!!!!!!!!!"
    ...
    tr.prepare_data(parameter, percentage)
    tr.train()
    tr.test(acceptable_range)
